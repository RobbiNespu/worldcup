...
<%@ page import = "java.util.*" %>
  ...
  [SSI Schaefer Euro 2012 competition] Dupa primele 14 meciuri din faza grupelor la turneul final, situatia in clasament e din ce in ce mai stransa , aio isi mentine primul loc, fiind urmata la 3 puncte de sorin, podiumul fiind completat de ata la alte 2 puncte distanta.
  Intre locul 4 si locul 32 este o diferenta de doar 4 puncte. 
  Dintre campionii editiilor trecute, aio isi mentine fara nici o problema primul loc, aci cade dramatic in clasament pe locul 30, tmu se claseaza pe locul 58, iar dco revine puternic pe locul 65. 
  Printre performerii ultimei etape sunt sorin, care a reusit sa obtina 7 puncte din ultimele 2 meciuri si cop, bci, rado, fha, osa care a prins scorul de 4-0 la partida Spania-Irlanda.
  </SPAN>
  </DIV>
  </MARQUEE>
  </td>
