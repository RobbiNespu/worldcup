...
public class Updater {
	...
	public static void main(String[] args) throws ParseException {
		...
		MatchData[] data = {
				new MatchData(64, "https://m.flashscore.ro/meci/Qqe1o0TE/", simpleDateFormat.parse("22.03.2018 14:45")), //
				new MatchData(63, "https://m.flashscore.ro/meci/KAvDEopp/?s=2",
						simpleDateFormat.parse("22.03.2018 14:45")), //
				new MatchData(62, "https://m.flashscore.ro/meci/d0RJgcK5/?s=2",
						simpleDateFormat.parse("22.03.2018 14:45")) };
	...
	private static void informServerAboutTheWinningTeam(MatchData match, Node score) {
		...
		URLReader.readURL("http://172.28.154.100:8080/worldcup2014/setMatchQualifiedTeam.jsp?id=" + match.index
				+ "&team=" + (g1 > g2 ? "1" : "2"));
	...
	protected static void informServerAboutTheScore(MatchData match, Node score) {
		String splits[] = score.toString().split(":");
		URLReader.readURLNoProxy("http://timw0186:8999/worldcup/setResult.jsp?id=" + match.index + "&g1=" + splits[0]
				+ "&g2=" + splits[1]);
